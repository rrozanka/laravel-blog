        ...
        <div class="col-lg-10">
            ...
            {{ Form::model($record, array('route' => ['posts.update', $record->id], 'class' => 'form-horizontal', 'method' => 'put')) }}
                ...
                <div class="form-group @if($errors->has('category'))has-error@endif">
                    ...
                    <div class="col-sm-10">
                        {{ Form::select('category', $categories, $record->category->id, array('class' => 'form-control', 'placeholder' => 'Category', 'autocomplete' => 'off')) }}
                    </div>
                </div>
                ...
                <div class="form-group @if($errors->has('tags'))has-error@endif">
                    ...
                    <div class="col-sm-10">
                        {{ Form::select('tags[]', $tags, $tagsIds, array('class' => 'form-control', 'placeholder' => 'Tags', 'autocomplete' => 'off', 'multiple' => 'multiple')) }}
                    </div>
                </div>
