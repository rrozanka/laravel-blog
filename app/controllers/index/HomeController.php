...
class HomeController extends \BaseController
{
    ...
    public function getLogin()
    {
        ...
        return \View::make('index.home.login');
    }
    ...
    public function postStore($id)
    {
        ...
        if ($validator->passes()) {
            ...
            return \Redirect::action('App\Controllers\Index\HomeController@getPost', $post->id)->with('message', 'Comment has been saved successfully');
        } else {
            return \Redirect::action('App\Controllers\Index\HomeController@getPost', $post->id)->withErrors($validator)->withInput();
        }
    }
